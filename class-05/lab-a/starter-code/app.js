...
function sum(a, b) { //eslint-disable-line
    let conclution = a + b;
    let message = 'The sum of '+a+' and '+b+' is '+conclution+'.';
    return [conclution,message];
}
...
ement is the product of those numbers, and the second element is a string that EXACTLY follows this example 
...
function multiply(a, b) { //eslint-disable-line
    let mult = a * b;
    let massage = 'The product of '+a+' and '+b+' is '+mult+'.';
    return[mult,massage];
}
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition,
 use your sum() function, and to do multiplication, use your multiply() function that you've already created.
  You're going to have to be resourceful to figure out how to do this. However, you may continue to 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    let v5=multiply(a,b);
    let v6=v5[0];
    let v7=multiply(v6,c);
    let v8=v7[0];
    let message1=a+' and '+b+' and '+c+' sum to '+v4+'.';
let message2='The product of '+a+' and '+b+' and '+c+' is '+v8+'.';
return [v4,v8,message1,message2];
...
function sumArray(sumArr) { //eslint-disable-line
    let v1=sum(sumArr[0],sumArr[1]);
    let v2=v1[0];
    let v3=sum(sumArr[2],v2);
    let v4=v3[0];

    
let message=sumArr[0]+ ',' + sumArr[1] +','+ sumArr[2]+' was passed in as an array of numbers, and ' +v4+ ' is their sum.';
return[v4,message];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    let v1=multiply(multArr[0],multArr[1]);
    let v2=v1[0];
    let v3=multiply(multArr[2],v2);
    let v4=v3[0];

    
let message='The numbers '+ multArr[0]+ ',' + multArr[1] +','+ multArr[2]+' have a product of ' +v4+'.';
return[v4,message];
}
